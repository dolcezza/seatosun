...
/*
	Class: AtomicPress
		AtomicPress class.
*/
class AtomicPress implements ArrayAccess {
	...
	*/
	public function __construct() {
        ...
        // set defaults
        $path = dirname(dirname(__FILE__));
        $this->addHelper(new PathAtomicPressHelper($this));

		// register paths
        $this['path']->register($path, 'atomicpress');
	...
	*/
	public static function getInstance() {
		...
		if (!isset(self::$_instance)) {
			self::$_instance = new AtomicPress();
		}
	...
	*/
	public function loadHelper($helpers, $suffix = 'AtomicPressHelper') {
