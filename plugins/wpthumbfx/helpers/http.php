<?php
/*
	Class: HttpAtomicPressHelper
		HTTP helper class
*/    
class HttpAtomicPressHelper extends AtomicPressHelper {

	/* current transport class */
	var $transport;

	/* available transport classes */
	var $transports = array('AtomicPressHttpCurl', 'AtomicPressHttpStreams', 'AtomicPressHttpSocket');
...
/*
	Class: AtomicPressHttpCurl
		HTTP transport class using cURL
*/
class AtomicPressHttpCurl extends AtomicPressHttp {
...
/*
	Class: AtomicPressHttpStreams
		HTTP transport class using fopen and streams
*/
class AtomicPressHttpStreams extends AtomicPressHttp {
...
/*
	Class: AtomicPressHttpSocket
		HTTP transport class using fsockopen
*/
class AtomicPressHttpSocket extends AtomicPressHttp {
