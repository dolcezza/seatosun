		...
		$.ajax({
			...
			past:1,
				...
				alert("OH CRAP");
                            ...
                            b["StartDate"] = a[0].StartDate;
                            b["EndDate"] = a[a.length - 1].StartDate;
				b.id="eo_events_past_widget-2";
                            populateAgenda(a, b,"old_dates")
                        }
                    }
                })
            }
            function populateAgenda(a, b, which) {
                var agendaWidget = $("#" + b.id + "_container");
                var dateList = agendaWidget.find("ul."+which);
